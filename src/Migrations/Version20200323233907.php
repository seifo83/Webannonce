 ...
 */
final class Version20200323233907 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE note ADD membre_note_id_id INT DEFAULT NULL, ADD membre_notant_id_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE commentaire ADD membre_id_id INT DEFAULT NULL, ADD annonce_id_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE annonce ADD membre_id_id INT DEFAULT NULL, ADD photo_id_id INT DEFAULT NULL, ADD categorie_id_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE annonce DROP membre_id_id, DROP photo_id_id, DROP categorie_id_id');
        ...
        $this->addSql('ALTER TABLE commentaire DROP membre_id_id, DROP annonce_id_id');
        ...
        $this->addSql('ALTER TABLE note DROP membre_note_id_id, DROP membre_notant_id_id');
    }
}
